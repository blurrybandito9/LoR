...
gdjs.graCode.mapOfGDgdjs_46graCode_46GDkostka2Objects1Objects = Hashtable.newFrom({"kostka2": gdjs.graCode.GDkostka2Objects1});gdjs.graCode.eventsList0x6d0400 = function(runtimeScene) {
...
gdjs.graCode.condition0IsTrue_0.val = false;
{
gdjs.graCode.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 3, "tworzenie2");
...
}; //End of gdjs.graCode.eventsList0x6d0400
gdjs.graCode.mapOfGDgdjs_46graCode_46GDkostkaObjects1Objects = Hashtable.newFrom({"kostka": gdjs.graCode.GDkostkaObjects1});gdjs.graCode.mapOfGDgdjs_46graCode_46GDplayerObjects1Objects = Hashtable.newFrom({"player": gdjs.graCode.GDplayerObjects1});gdjs.graCode.mapOfGDgdjs_46graCode_46GDkostkaObjects1Objects = Hashtable.newFrom({"kostka": gdjs.graCode.GDkostkaObjects1});gdjs.graCode.eventsList0x6d1338 = function(runtimeScene) {
...
}; //End of gdjs.graCode.eventsList0x6d1338
gdjs.graCode.mapOfGDgdjs_46graCode_46GDplayerObjects1Objects = Hashtable.newFrom({"player": gdjs.graCode.GDplayerObjects1});gdjs.graCode.mapOfGDgdjs_46graCode_46GDkostka2Objects1Objects = Hashtable.newFrom({"kostka2": gdjs.graCode.GDkostka2Objects1});gdjs.graCode.eventsList0x6d1d98 = function(runtimeScene) {
...
}; //End of gdjs.graCode.eventsList0x6d1d98
...
{for(var i = 0, len = gdjs.graCode.GDplayerObjects1.length ;i < len;++i) {
    gdjs.graCode.GDplayerObjects1[i].setPosition(210,350);
}
...
{ //Subevents
gdjs.graCode.eventsList0x6d0400(runtimeScene);} //End of subevents
}
...
/* Reuse gdjs.graCode.GDplayerObjects1 */
{for(var i = 0, len = gdjs.graCode.GDplayerObjects1.length ;i < len;++i) {
    gdjs.graCode.GDplayerObjects1[i].addPolarForce(180, 600, 0);
}
}}
...
/* Reuse gdjs.graCode.GDplayerObjects1 */
{for(var i = 0, len = gdjs.graCode.GDplayerObjects1.length ;i < len;++i) {
    gdjs.graCode.GDplayerObjects1[i].addPolarForce(0, 600, 0);
}
}}
...
gdjs.graCode.condition0IsTrue_0.val = false;
{
gdjs.graCode.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 3, "tworzenie");
}if (gdjs.graCode.condition0IsTrue_0.val) {
...
{ //Subevents
gdjs.graCode.eventsList0x6d1338(runtimeScene);} //End of subevents
}
...
{ //Subevents
gdjs.graCode.eventsList0x6d1d98(runtimeScene);} //End of subevents
}
